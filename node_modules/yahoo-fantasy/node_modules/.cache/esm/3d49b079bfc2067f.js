let mapTeam,mapStats,mapRoster,mapDraft,mapMatchups,extractCallback;_bfc‍.x([["default",()=>_bfc‍.o]]);_bfc‍.w("../helpers/teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}],["mapStats",["mapStats"],function(v){mapStats=v}],["mapRoster",["mapRoster"],function(v){mapRoster=v}],["mapDraft",["mapDraft"],function(v){mapDraft=v}],["mapMatchups",["mapMatchups"],function(v){mapMatchups=v}]]);_bfc‍.w("../helpers/argsParser.mjs",[["extractCallback",["extractCallback"],function(v){extractCallback=v}]]);
