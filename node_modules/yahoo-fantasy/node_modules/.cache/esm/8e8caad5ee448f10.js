let mapPlayer;_ee4‍.x([["mapLeagues",()=>mapLeagues],["mapPlayers",()=>mapPlayers],["mapWeeks",()=>mapWeeks],["mapStatCategories",()=>mapStatCategories],["mapPositionTypes",()=>mapPositionTypes],["mapRosterPositions",()=>mapRosterPositions],["parseCollection",()=>parseCollection]]);_ee4‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);
  ...
  return players.reduce((result, p) => {
    if (p.player) {
      result.push(_ee4‍.a("mapPlayer",mapPlayer)(p.player[0], p.player[1]));
    }
