let mapPlayer,mergeObjects,flattenObject,mapPlayers;_92e‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);_92e‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);_92e‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);_92e‍.w("./gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);



       function mapTeam(t) {
  const team = _92e‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  return _92e‍.a("mapPlayers",mapPlayers)(players);
}
